...
class PartyLed:
    def __init__(self , driver):
        ...
        self.edit=(By.XPATH, "//button[normalize-space(text())='EDIT']")
        self.edit_me = (By.XPATH,"//div[@title='AO14-KAT-82/83']")
    ...
    def opening_entry_click(self):
        ...
        party_ledger_click_me = self.wait.until(EC.element_to_be_clickable((By.LINK_TEXT, "Party Opening B/L")))
        self.driver.execute_script("arguments[0].scrollIntoView(true);", party_ledger_click_me)
        self.driver.execute_script("arguments[0].click();", party_ledger_click_me)
    ...
    def selecting_edit(self):
        element = self.wait.until(EC.element_to_be_clickable(self.edit_me))
        self.actions = ActionChains(self.driver)
